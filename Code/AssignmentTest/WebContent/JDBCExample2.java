...
public class JDBCExample2 {
    ...
    public static void main(String[] args)
    {
 	 ...
 	 try {
	     ...
	     rs = stmt.executeQuery("SELECT SURNAME,FIRSTNAME,YEAR,CC,NUM FROM EE_ADMIN.CUSTOMERS cust, EE_ADMIN.SALES sales WHERE cust.ID=sales.PURCHASER");

	     while (rs.next())
                System.out.println("\n" + rs.getString("FIRSTNAME") + " " + rs.getString("SURNAME") + " drives registration " + rs.getString("YEAR") + rs.getString("CC") + rs.getString("NUM"));
	 }
